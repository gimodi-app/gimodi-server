...
import { handleKick, handleBan, handlePoke, handleListBans, handleRemoveBan, handleGetAuditLog, handleMoveUser, handleListUsers, handleDeleteUser, handleBulkDeleteUsers, handleBanByUserId } from './admin.js';
...
async function routeMessage(client, type, data, id) {
  try {
    switch (type) {
      case 'channel:join':            return handleJoinChannel(client, data, id);
      case 'channel:leave':           return handleLeaveChannel(client, data, id);
      ...
      case 'user:get-nicknames':      return handleGetNicknames(client, data, id);
      ...
      case 'chat:dm-send':            return handleDmSend(client, data, id);
      case 'chat:dm-history':         return handleDmHistory(client, data, id);
      case 'chat:server-send':        return handleServerChatSend(client, data, id);
      case 'chat:server-history':     return handleServerChatHistory(client, data, id);
      case 'chat:server-delete':      return handleServerChatDelete(client, data, id);
      case 'chat:typing':             return handleTypingIndicator(client, data, id);
      case 'chat:react':              return handleReact(client, data, id);
      case 'chat:unreact':            return handleUnreact(client, data, id);
      ...
      case 'file:list':               return handleFileList(client, data, id);
      case 'file:delete':             return handleFileDelete(client, data, id);

      case 'voice:get-rtp-capabilities': return await handleGetRtpCapabilities(client, data, id);
      case 'voice:rtp-capabilities':    return handleRtpCapabilities(client, data, id);
      case 'voice:create-transport':    return await handleCreateTransport(client, data, id);
      case 'voice:connect-transport':   return await handleConnectTransport(client, data, id);
      case 'voice:produce':             return await handleProduce(client, data, id);
      case 'voice:consumer-resume':     return await handleConsumerResume(client, data, id);
      case 'voice:mute-state':          return handleMuteState(client, data, id);
      case 'voice:request':             return handleVoiceRequest(client, data, id);
      case 'voice:cancel-request':      return handleVoiceCancelRequest(client, data, id);

      case 'screen:start':             return handleScreenStart(client, data, id);
      case 'screen:stop':              return handleScreenStop(client, data, id);

      case 'webcam:start':             return handleWebcamStart(client, data, id);
      case 'webcam:stop':              return handleWebcamStop(client, data, id);

      case 'token:redeem':             return handleTokenRedeem(client, data, id);
      case 'token:list':               return handleTokenList(client, data, id);
      case 'token:create':             return handleTokenCreate(client, data, id);
      case 'token:delete':             return handleTokenDelete(client, data, id);

      case 'admin:get-user-roles':     return handleGetUserRoles(client, data, id);
      case 'admin:assign-role':        return handleAssignRole(client, data, id);
      case 'admin:remove-role':        return handleRemoveRole(client, data, id);
      case 'admin:assign-role-by-userid':   return handleAssignRoleByUserId(client, data, id);
      case 'admin:remove-role-by-userid':   return handleRemoveRoleByUserId(client, data, id);
      case 'admin:get-user-roles-by-userid': return handleGetUserRolesByUserId(client, data, id);

      case 'role:list':                return handleRoleList(client, data, id);
      case 'role:list-permissions':    return handleRoleListPermissions(client, data, id);
      case 'role:create':              return handleRoleCreate(client, data, id);
      case 'role:update':              return handleRoleUpdate(client, data, id);
      case 'role:delete':              return handleRoleDelete(client, data, id);
      ...
      case 'admin:move-user':         return await handleMoveUser(client, data, id);
      case 'admin:list-bans':         return handleListBans(client, data, id);
      case 'admin:remove-ban':        return handleRemoveBan(client, data, id);
      case 'admin:audit-log':         return handleGetAuditLog(client, data, id);
      case 'admin:grant-voice':       return handleGrantVoice(client, data, id);
      case 'admin:revoke-voice':      return handleRevokeVoice(client, data, id);
      case 'admin:poke':              return handlePoke(client, data, id);
      case 'admin:list-users':        return handleListUsers(client, data, id);
      case 'admin:delete-user':       return handleDeleteUser(client, data, id);
