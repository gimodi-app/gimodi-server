...
export const PERMISSIONS = {
  ...
  CHAT_SLASH_UPTIME: 'chat.slash.uptime',
  CHAT_PIN: 'chat.pin',
...
export const PERMISSION_GROUPS = [
  {
    ...
    permissions: ['channel.create', 'channel.group_create', 'channel.placeholder_create', 'channel.create_temporary', 'channel.update', 'channel.delete'],
  },
  {
    id: 'channel_bypass',
  ...
  },
  {
    id: 'chat',
    label: 'Chat',
    permissions: ['chat.server', 'chat.delete_any', 'chat.edit_any', 'chat.server_delete', 'chat.slash.clear', 'chat.slash.purge', 'chat.slash.uptime', 'chat.pin'],
  },
  {
    id: 'voice',
    label: 'Voice',
    permissions: ['voice.grant', 'voice.revoke'],
  },
  {
    id: 'user',
    label: 'User Management',
    permissions: ['user.kick', 'user.ban', 'user.move', 'user.poke', 'user.view_ip', 'user.assign_role'],
  },
  {
    id: 'ban',
    label: 'Ban Management',
    permissions: ['ban.list', 'ban.remove'],
  },
  {
    id: 'token',
    label: 'Token Management',
    permissions: ['token.create', 'token.list', 'token.delete'],
  },
  {
    id: 'file',
    label: 'File Management',
    permissions: ['file.browse', 'file.delete'],
  },
  {
    id: 'role',
...
export const PERMISSION_LABELS = {
  ...
  'chat.slash.uptime': 'View Server Uptime',
